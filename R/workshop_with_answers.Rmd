...
(4) Create a nice table with descriptive statistics using `tbl_summaru` from the `tableone` package. Include `smoking_unobserved`. 
...
table1_bm <- tbl_summary(data=df, by = intervention)
